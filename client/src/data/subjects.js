...
// professor 필드는 운영자가 직접 채운다 (현재 빈 문자열).

export const subjects = [
    { id: 'all', name: 'ALL', professor: '', track: '', description: '' },

    {
        id: 'intro', name: '디지털인문예술입문', professor: '김용수', track: '공통 기초',
    ...
    {
        id: 'aidesign', name: 'AI디자인', professor: '송한나', track: '미래융합디자인',
    ...
    {
        id: 'storytelling', name: '스토리텔링창작실습', professor: '김지현', track: '문화예술콘텐츠',
        description: '우리 주변의 문화적 소재를 찾아 매력적인 이야기로 만드는 실습 수업입니다. 팀 프로젝트를 통해 기획부터 디자인 제작까지 함께하며, 이야기를 시각적인 결과물로 완성해 전시하는 경험을 합니다.'
    },

    {
        id: 'dd3', name: '디지털디자인3', professor: '이은솔', track: '미래융합디자인',
        description: '실제 스마트폰 앱 서비스의 UX를 개선하는 실전형 수업입니다. UX 디자인을 실무 수준에서 정밀하게 배울 수 있으며, 각 조사 단계를 실제로 거치면서 단계부터 논리, 과정을 경험할 수 있습니다.'
    },

    {
        id: 'regional', name: '지역혁신연구방법론', professor: '한수미', track: 'AI디지털인문학',
        description: '빅데이터를 활용해 우리 지역의 문제를 해결하는 방법을 배웁니다. 설문조사와 인터뷰 데이터를 AI 도구로 분석하여, 지역 사회에 도움이 되는 실질적인 해결책을 제안하는 프로젝트를 진행합니다.'
    },

    {
        id: 'club', name: '디인예 전공 동아리', professor: '김용수, 김성우, 유인선', track: '동아리',
        description: '디지털인문예술전공 학생들이 자율적으로 구성한 동아리 활동의 결과물입니다. 전공 수업 외에도 다양한 창작 실험과 협업을 통해 만들어진 작품을 선보입니다.'
    },

    {
        id: 'free', name: '자율 프로젝트', professor: '', track: '자율',
        description: '수업과 무관하게 개인 또는 팀이 자율적으로 기획하고 제작한 프로젝트입니다. 전공 내외의 다양한 관심사와 실험적 시도가 담긴 작품을 만나볼 수 있습니다.'
    },
]