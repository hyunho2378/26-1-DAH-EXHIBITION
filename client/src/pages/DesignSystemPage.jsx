    ...
    <div className="pt-10 pb-24">
          ...
          {COLOR_TOKENS.map(t => (
            <div key={t.name}>
              <div
                ...
                style={{ background: t.hex, border: '1px solid #2a2a2a', borderRadius: '4px' }}
              />
              <p className="text-xs font-semibold text-text-primary font-ui">{t.label}</p>
              <p className="text-xs text-text-muted font-ui mt-0.5">{t.hex}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-6">
          {TYPE_SCALE.map(t => (
            <div key={t.token} style={{ borderBottom: '1px solid #1f1f1f', paddingBottom: '20px' }}>
